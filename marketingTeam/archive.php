<?php get_header(); ?>
<meta name="description" content="Saiba tudo sobre marketing, negócios e empreendedorismo em nosso blog. Confira todas as categorias!">
		...
		<div class="row">
			<div class="col-12">
				<div class="bg-primary  p-4 text-center rounded-3">
					<h1 class="text-white m-0"><?php $categories = get_the_category(); if ( ! empty( $categories ) ) {	echo esc_html( $categories[0]->name );	} ?></h1>
